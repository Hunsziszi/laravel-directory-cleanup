...
class TestCase extends OrchestraTestCase
{
    ...
    protected function initializeDirectory($directory)
    {
        ...
        file_put_contents($directory.DIRECTORY_SEPARATOR.'.gitignore', '*'.PHP_EOL.'!.gitignore');
    }

    protected function getTempDirectory($subDirectory = '', $createIfNotExists = false)
    {
        $fullDirectoryName = __DIR__.DIRECTORY_SEPARATOR."temp".DIRECTORY_SEPARATOR."{$subDirectory}";
